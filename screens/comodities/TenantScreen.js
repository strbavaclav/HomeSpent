...
const TenantScreen = (props) => {
  ...
  const comodities = useSelector((state) => state.comodities.tenantCom);
    ...
    Alert.alert(
      ...
      [
        { text: 'No', style: 'default' },
        {
          ...
          style: 'destructive',
          onPress: () => {
            dispatch(comodityActions.DissboundTenantComodity(id));
            loadComodities();
          },
        },
      ]
    ...
    return (
      <View style={{ flex: 1 }}>
        <View style={{ marginHorizontal: 20, marginTop: 10 }}>
          ...
          >
            Here you can add all your rentals
          </Text>
        </View>
        <NoComodities />
        <JoinComodityTab type='Tenant' />
      </View>
    );
  }
  //tělo komponentu
